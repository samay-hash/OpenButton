    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          type="button"
          className={cn(
            "flex size-8 cursor-pointer items-center justify-center rounded-full p-1.5 text-foreground/80 transition-all duration-300 hover:bg-foreground/10 active:scale-95",
            className
          )}
          onClick={toggleTheme}
